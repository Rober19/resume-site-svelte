...
<i data-fa-symbol="delete" class="fas a-trash fa-fw" />
...
<svg hidden="hidden">
  <defs>
    <symbol id="icon-codepen" viewBox="0 0 32 32">
      <title>codepen</title>
      <path
        d="M31.872 10.912v-0.032c0-0.064 0-0.064 0-0.096v-0.064c0-0.064
    ...
    <symbol id="icon-github" viewBox="0 0 32 32">
      <title>github</title>
      <path
        d="M16.192 0.512c-8.832 0-16 7.168-16 16 0 7.072 4.576 13.056 10.944
    ...
    <symbol id="icon-facebook" viewBox="0 0 32 32">
      ...
      <path
        d="M19 6h5v-6h-5c-3.86 0-7 3.14-7
    ...
    <symbol id="icon-instagram" viewBox="0 0 32 32">
      ...
      <path
        d="M16 2.881c4.275 0 4.781 0.019 6.462 0.094 1.563 0.069 2.406 0.331
      ...
      <path
        d="M16 7.781c-4.537 0-8.219 3.681-8.219 8.219s3.681 8.219 8.219 8.219
      ...
      <path
        d="M26.462 7.456c0 1.060-0.859 1.919-1.919
    ...
    <symbol id="icon-twitter" viewBox="0 0 32 32">
      <title>twitter</title>
      <path
        d="M32 7.075c-1.175 0.525-2.444 0.875-3.769 1.031 1.356-0.813 2.394-2.1
    ...
    <symbol id="icon-behance" viewBox="0 0 32 32">
      <title>behance</title>
      <path
        d="M9.281 6.412c0.944 0 1.794 0.081 2.569 0.25 0.775 0.162 1.431 0.438
      ...
      <path
        d="M22.663 22.675c0.587 0.575 1.431 0.863 2.531 0.863 0.788 0 1.475-0.2
    ...
    <symbol id="icon-link" viewBox="0 0 32 32">
      <title>link</title>
      <path
        d="M17.984 11.456c-0.704 0.704-0.704 1.856 0 2.56 2.112 2.112 2.112
      ...
      <path
        d="M29.344 2.656c-1.696-1.728-3.968-2.656-6.4-2.656s-4.672 0.928-6.4
